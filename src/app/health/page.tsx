    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-8 font-sans">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md text-center">
          <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Health Check</h1>
          <div className="space-y-2">
            <p className="text-green-600 dark:text-green-400 font-medium text-lg">db is healthy</p>
            <p className="text-gray-600 dark:text-gray-300">
              Total users currently: <span className="font-bold text-gray-900 dark:text-white">{userCount}</span>
            </p>
          </div>
        </div>
      </div>
